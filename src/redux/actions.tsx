...
export const UPDATE_COMPARED_TABLE_BASE_CURRENCY = 'UPDATE_COMPARED_TABLE_BASE_CURRENCY';
export const UPDATE_COMPARED_TABLE_COMPARED_CURRENCY = 'UPDATE_COMPARED_TABLE_COMPARED_CURRENCY';
